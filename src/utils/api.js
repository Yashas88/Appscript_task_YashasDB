...
const MOCK_PRODUCTS = [
  {
    ...
    price: 109.95,
    description: "Your perfect pack for everyday use and target walks in the forest.",
  ...
  {
    id: 11,
    title: "Silicon Power 256GB SSD A55 SATA III 2.5\" SSD",
    price: 109.0,
    description: "3D NAND flash are applied to deliver high transfer to better daily computing.",
    category: "electronics",
  ...
  },
  {
    ...
    price: 999.99,
    description: "49-Inch super ultra-wide monitor with dual QHD resolution.",
    category: "electronics",
  ...
  },
  {
    ...
    price: 56.99,
    description: "Note: The Jackets are US standard. Please choose S-XL based on your usual size.",
  ...
  },
  {
    ...
    category: "women's clothing",
    image: "https://fakestoreapi.com/img/71HblAHs5xL._AC_UY879._SX._UX._SY._UY_.jpg",
  ...
  },
  {
    ...
    price: 7.95,
    description: "100% Polyester, machine washable.",
    category: "women's clothing",
  ...
  },
  {
    ...
    price: 12.99,
    description: "95% Cotton, 5% Spandex. Features casual style.",
    category: "women's clothing",
